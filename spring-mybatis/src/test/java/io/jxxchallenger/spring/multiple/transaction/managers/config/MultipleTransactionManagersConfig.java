package io.jxxchallenger.spring.multiple.transaction.managers.config;
...
@ComponentScan(basePackages = {"io.jxxchallenger.spring.mybatis.service", "io.jxxchallenger.spring.multiple.transaction.managers"})
